...
// import { GetAllUsersDocument } from "@/client/apollo/generated/graphql";
// import type { GetAllUsersQuery } from "@/core/api/graphql/generated/backend";

// export async function UserListServer() {
//   // Query para obtener todos los usuarios
//   const { data: allUsers } = await getClient().query<GetAllUsersQuery>({
